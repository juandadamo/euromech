...
We found, for $B=4.43\cdot10^{-5}\SI{}{\newton\meter}$ Mode 1 in $\ell/D$=0.75. For $B=23.4\cdot10^{-5}\SI{}{\newton\meter}$
 ...
 It is important in order to define a reduce velocity number $U_R = f_n D / u_\infty$
  \begin{figure}
 	\includegraphics[width=0.6\textwidth]{Ur_Cd}
 ...
 \begin{figure}
 	\includegraphics[width=0.6\textwidth]{Ur_Cy}
 	\caption{Two elastic modes }
 \end{figure}
 
  \begin{figure}
 	\includegraphics[width=0.6\textwidth]{Cy_Cd}
 	\caption{Cauchy $\displaystyle Ca = \frac{\rho u_\infty^2\ell^3}{8B}$ is not enough to reduce the problem. }
 \end{figure}
 
 \section{Deformations and vibration}
 	\begin{figure}		
 	\begin{subfigure}[t]{.5\textwidth}
 		\centering\resizebox{\textwidth}{!}{%
 		 			\includegraphics{Cy_delta}	
 		} 	\subcaption{Foils displacements }
 	\end{subfigure}
 	\begin{subfigure}[t]{.5\textwidth}
 		\centering\resizebox{\textwidth}{!}{%
 				\includegraphics{Cy_delta_std}	
 		} \subcaption{Amplitude of displacements fluctuations}
 	\end{subfigure}	
\end{figure}
	...
	\begin{subfigure}[t]{.5\textwidth}
		\centering\resizebox{\textwidth}{!}{%
			\includegraphics{Cy_fvs_ffoil}	
		} 	\subcaption{ }
	\end{subfigure}
	\begin{subfigure}[t]{.5\textwidth}
		\centering\resizebox{\textwidth}{!}{%
			\includegraphics{Cy_fn_ffoil}	
		} \subcaption{}
	\end{subfigure}	
\end{figure}
